...
internal class GridRVAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        courseIV = convertView!!.findViewById(R.id.idIVGrocery)
        courseTV = convertView.findViewById(R.id.idTVGrocery)
        // on below line we are setting image for our course image view.
        courseIV.setImageResource(courseList[position].groceryPhoto)
        // on below line we are setting text in our course text view.
        courseTV.setText(courseList[position].groceryName)
